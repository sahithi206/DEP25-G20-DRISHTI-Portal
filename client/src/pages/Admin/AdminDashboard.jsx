  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="p-6">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-1">Admin Dashboard Overview</h2>
            <p className="text-gray-500">Welcome back! Here's what's happening with your schemes and projects.</p>
          </div>
              ...
              >
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className={`h-10 w-10 rounded-full flex items-center justify-center ${
                    card.type === "schemes" ? "bg-blue-100 text-blue-600" :
                ...
                {schemeDetailsLoading ? (
                  ...
                  <div>
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                      ...
                      <span className={`mt-2 sm:mt-0 text-sm px-3 py-1 rounded-full ${
