...
// const sectionTitles = {
//     principalInvestigator: "Principal Investigator Details",
...
//                                                         >
//                                                             <div className="w-1/4 font-semibold text-gray-700 text-left pr-4">{key}</div>
...
//                                         <h3 className="text-2xl font-bold text-gray-800 mb-6 pb-2 border-b-2">
//                                             {sectionTitles["principalInvestigator"]}
//                                         </h3>
//                                         <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 transition">
//                                             <h4 className="text-xl font-bold text-gray-700 mb-4">PI/Co-PI Details</h4>
