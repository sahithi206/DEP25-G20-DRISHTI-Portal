        ...
        <div className="p-6 space-y-6 mt-16">
          <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
              ...
              {message && (
                <div className={`p-4 mb-6 rounded-md ${messageType === "success" ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"
                  }`}>
                  {message}
                </div>
              )}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-1.5">
                      <div
                        className={`h-1.5 rounded-full ${passwordStrength === 0 ? "bg-gray-300 w-0" :
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition ${confirmPassword && password !== confirmPassword ? "border-red-500" : "border-gray-300"
                      }`}
