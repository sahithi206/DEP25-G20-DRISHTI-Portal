...
const SavedProposals = () => {
  ...
  <div className="w-full sm:flex-1 min-w-[200px]">
    <div className="relative flex items-center rounded-lg px-3 py-2 bg-gray-50 hover:bg-gray-100 transition-colors duration-200 focus-within:bg-white focus-within:ring-1 focus-within:ring-blue-200">
      <svg
  ...
  <div className="w-full sm:w-auto flex flex-col sm:flex-row gap-3">
    <div className="relative w-full sm:w-40">
      <select
        className="appearance-none w-full bg-white rounded-md pl-3 pr-8 py-2 text-sm text-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 border border-gray-300"
        value={sortOrder}
