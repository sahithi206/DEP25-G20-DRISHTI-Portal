  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1">
        <div className="bg-gradient-to-r from-teal-600 to-teal-800 py-4 px-4 shadow-md">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-2xl font-bold text-white">{profile.role} Profile : {profile.college}</h1>
            <p className="mt-2 text-xl text-teal-100">{profile.name}</p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-12">
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-1 gap-x-12 gap-y-10">
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-2">Name</h3>
                  <p className="text-2xl font-medium text-gray-900">{profile.name}</p>
                </div>
                
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-2">Email</h3>
                  <p className="text-2xl font-medium text-gray-900">{profile.email}</p>
                </div>
                
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-2">Role</h3>
                  <p className="text-2xl font-medium text-gray-900">{profile.role}</p>
                </div>
                
                <div>
                  <h3 className="text-sm font-medium text-gray-500 mb-2">College</h3>
                  <p className="text-2xl font-medium text-gray-900">{profile.college}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {showPasswordForm ? (
                ...
                <form onSubmit={handlePasswordSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end mt-8">
                    <button
                      ...
                      className="px-8 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition duration-300 shadow-md"
                    >
                      Update Password
                    </button>
                  </div>
              ...
              <div className="p-8 flex items-center justify-center">
                <div className="text-center max-w-lg py-12">
                  ...
                  <h3 className="text-xl font-medium text-gray-900 mb-2">Password Management</h3>
