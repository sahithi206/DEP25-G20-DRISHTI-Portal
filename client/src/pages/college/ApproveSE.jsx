                  ...
                  {pendingRequests.map((request) => (
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <div>
                          <h3 className="font-medium text-gray-800">Project: {request.name}</h3>
                ...
                <div id="se-details" className="bg-white rounded-lg p-6 border-t-4 border-blue-800">
                  ...
                  <div className="flex justify-end space-x-4 mt-6">
                    ...
                    <button
                      ...
                      className={`px-6 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 flex items-center ${
                        instituteStamp
