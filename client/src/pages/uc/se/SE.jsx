...
const UCForm = () => {
    ...
    const [data, setData] = useState({ grantType: "recurring" });
                ...
                <div className="p-6 space-y-6 mt-16">
                    ...
                    <div className="bg-white shadow-md rounded-lg p-6 mt-6 border-t-4 border-blue-800">
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <span className="px-3 py-1 w-full">: (Project Number)</span>
                        </div>

                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <label className="font-semibold text-gray-700">Name of the grant receiving Organization</label>
                            <span className="px-3 py-1 w-full">: (Institute)</span>
                            ...
                            <span className="px-3 py-1 w-full">: 2</span>
                        ...
                        <div className="border border-gray-400 rounded px-3 py-3 w-full-4">
                            ...
                            <ul className="list-disc pl-7">
                                <li>Balance available at end of financial year<span className="text-gray-500">: Total </span></li>
                                <li>Balance (Carry forward to next financial year)<span className="text-gray-500">: Total </span></li>
                            </ul>
                        </div>
