      ...
      <div className={`flex flex-col transition-all duration-300 ${isSidebarOpen ? 'ml-64 w-[calc(100%-16rem)]' : 'ml-16 w-[calc(100%-4rem)]'}`}>
        ...
        <div className="p-6 space-y-6 mt-16">
          <div className="bg-white shadow-md rounded-xl p-6 text-center border-l-8 border-blue-700 hover:shadow-xl transition-shadow">
            ...
            <p className="mt-3 text-2xl font-bold text-blue-800">Yearly Progress Report</p>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    <textarea
                      ...
                      rows={3}
                      className="px-3 py-1 w-full border rounded-lg"
                      maxLength={maxLengths.remainingWork}
                    />
                    <p className="text-sm text-gray-500">
                      {getCharactersLeft("remainingWork", data.remainingWork)} characters left
                    </p>
                  </div>
                </div>
              </>
